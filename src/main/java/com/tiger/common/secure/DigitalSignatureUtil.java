...
public class DigitalSignatureUtil {
    ...
    public static byte[] signWithMessageDigestAndCipher(byte[] messageBytes, String hashingAlgorithm,
    ...
    public static boolean verifyWithMessageDigestAndCipher(byte[] messageBytes, String hashingAlgorithm,
